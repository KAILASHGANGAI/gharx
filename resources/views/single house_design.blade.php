...
<span class="range text-center mt-2">Avg Range :{{$data->avetage_Rate}}</span>
<h2 class="display-5 py-3 single-heading">Design Name : {{$data->design_name}}</h2>
...
<div class="text-">
    ...
    <a href="/order_house_design/<?php echo base64_encode($data->id); ?>" class="order-btn">Order Now</a><br>
