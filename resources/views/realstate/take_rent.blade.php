...
<div class="col-7 col-sm-6 sliders ">
    <div class="realstate-h">
        <h1 class="pb-2"> Rooms , Flats and House Take in Rent </h1>
...
<div class="row pt-4">
    @if(isset($data))
        ...
        <div class="col-sm-3  ">
            ...
            <img src="{{asset('images/rent.png')}}" class="sell" alt="sell tag" height="50pxs" srcset="">
            <a href="/single_property/{{base64_encode($item->id)}}" class=" ">
                ...
                <div class="">
                    ...
                    <a href="/apply_property/{{base64_encode($item->id)}}" class="btn-danger px-4 py-2 float-right" style="margin-top:0;">Apply Now</a>
